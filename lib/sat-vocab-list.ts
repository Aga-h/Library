// The built-in SAT vocabulary list — 991 words.
//
// Kept in the repo rather than seeded straight into the database so it is diffable and
// reviewable: correcting a definition is an edit here plus a re-import, not a hand-run UPDATE.
// "Load the built-in list" runs it through the same parser a pasted list goes through, so there
// is exactly one import code path and no second format to keep working.
//
// One word per line, " - ", then the meaning; several senses are numbered "1. … 2. …".
// Re-importing replaces a word's meanings rather than duplicating them, so editing is safe.
export const SAT_VOCAB_LIST = `abase - to humiliate, degrade
...
abridge - 1. to cut down, shorten; 2. shortened
...
acumen - keen insight
acute - 1. sharp, severe; 2. having keen insight
adamant - impervious, immovable, unyielding
adept - extremely skilled
adhere - 1. to stick to something; 2. to follow devoutly
...
advocate - 1. to argue in favor of something; 2. a person who argues in favor of something
...
aggregate - 1. a whole or total; 2. to gather into a mass
...
animated - lively
annex - 1. to incorporate territory or space; 2. a room attached to a larger room or space
...
asylum - 1. a place of refuge, protection, a sanctuary; 2. an institution in which the insane are kept
atone - to repent, make amends
atrophy - to wither away, decay
attain - to achieve, arrive at
attribute - 1. to credit, assign; 2. a facet or trait
...
buttress - 1. to support, hold up; 2. something that offers support
...
canvas - 1. a piece of cloth on which an artist paints; 2. to cover, inspect
...
catalog - 1. to list, enter into a list; 2. a list or collection
...
censure - 1. harsh criticism; 2. to rebuke formally
...
chronicle - 1. a written history; 2. to write a history
...
clamor - 1. loud noise; 2. to loudly insist
clandestine - secret
cleave - 1. to divide into parts; 2. to stick together firmly
clemency - mercy
...
collateral - 1. secondary; 2. security for a debt
...
compound - 1. to combine parts; 2. a combination of different parts; 3. a walled area containing a group of buildings
...
convention - 1. an assembly of people; 2. a rule, custom
...
coup - 1. a brilliant, unexpected act; 2. the overthrow of a government and assumption of authority
...
embellish - 1. to decorate, adorn; 2. to add details to, enhance
embezzle - to steal money by falsifying records
emend - to correct or revise a written text
eminent - 1. distinguished, prominent, famous; 2. conspicuous
emollient - soothing
emote - to express emotion
empathy - sensitivity to another’s feelings as if they were one’s own
empirical - 1. based on observation or experience; 2. capable of being proved or disproved by experiment
emulate - to imitate
enamor - to fill with love, fascinate, usually used in passive form followed by “of” or “with”
encore - the audience’s demand for a repeat performance; also the artist’s performance in response to that demand
...
façade - 1. the wall of a building; 2. a deceptive appearance or attitude
facile - 1. easy, requiring little effort; 2. superficial, achieved with minimal thought or care, insincere
...
felicitous - 1. well suited, apt; 2. delightful, pleasing
feral - wild, savage
...
fraught - (usually used with “with”) filled or accompanied with
...
hapless - unlucky
harangue - 1. a ranting speech; 2. to give such a speech
...
incarnate - 1. existing in the flesh, embodied; 2. to give human form to
incendiary - 1. a person who agitates; 2. inflammatory, causing combustion
incessant - unending
...
incumbent - 1. one who holds an office; 2. obligatory
...
lavish - 1. given without limits; 2. to give without limits
...
liability - 1. something for which one is legally responsible, usually involving a disadvantage or risk; 2. a handicap, burden
...
manifest - 1. easily understandable, obvious; 2. to show plainly
...
moderate - 1. not extreme; 2. one who expresses moderate opinions
...
reconcile - 1. to return to harmony; 2. to make consistent with existing ideas
rectitude - uprightness, extreme morality
redoubtable - 1. formidable; 2. commanding respect
refract - to distort, change
refurbish - to restore, clean up
refute - to prove wrong
regurgitate - 1. to vomit; 2. to throw back exactly
relegate - 1. to assign to the proper place; 2. to assign to an inferior place
relish - to enjoy
remedial - intended to repair gaps in students’ basic knowledge
remiss - negligent, failing to take care
renovate - 1. restore, return to original state; 2. to enlarge and make prettier, especially a house
...
solvent - 1. a substance that can dissolve other substances; 2. able to pay debts
...
/** 991 — kept derived from the list itself so it cannot drift out of date. */
export const SAT_VOCAB_WORD_COUNT = SAT_VOCAB_LIST.trim().split("\n").length;
