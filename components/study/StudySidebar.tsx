...
import { ArrowLeft, BookA, GraduationCap, ListChecks } from "lucide-react";

const NAV_ITEMS = [
  { href: "/study/sat-vocab", label: "SAT Vocabulary", icon: BookA },
  ...
  return (
    <aside className="w-56 flex-shrink-0 flex flex-col bg-white border-r border-gray-200 min-h-screen">
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5">
        {NAV_ITEMS.map((item) => {
          const isActive = item.href === "/study/sat-vocab"
            ? pathname === "/study/sat-vocab"
