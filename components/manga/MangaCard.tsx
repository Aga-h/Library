...
export default function MangaCard({ manga }: { manga: Manga }) {
  ...
  return (
    <Link href={`/manga/${manga.id}`} className="group flex flex-col bg-white border border-gray-200 rounded-xl overflow-hidden hover:border-gray-400 hover:shadow-md transition-all">
