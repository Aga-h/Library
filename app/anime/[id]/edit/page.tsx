...
export default async function EditAnimePage({ params }: PageProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <Link href={`/anime/${anime.id}`} className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-800 mb-6 transition-colors">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8">
        ...
        <AnimeForm mode="edit" initialData={{
