  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/tv/new" className="flex items-center gap-2 bg-gray-900 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-gray-700 transition-colors">
