...
const createSchema = z.object({
  ...
  // Optional: a series with no universe lives on the books main page.
...
async function POSTHandler(request: NextRequest) {
  ...
  if (universeId && !(await db.bookUniverse.findUnique({ where: { id: universeId } }))) {
