...
export default async function NewBookSeriesPage() {
  const universeOptions = await bookUniverseOptions();
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8">
        ...
        <HierarchyForm mode="create" parentOptions={universeOptions} apiBase="/api/books/series" redirectTo="/library/books/s"
