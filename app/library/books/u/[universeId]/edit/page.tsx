...
export default async function EditBookUniversePage({ params }: PageProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8">
        ...
        <HierarchyForm mode="edit" apiBase="/api/books/universes" entityId={universe.id}
          redirectTo="/library/books/u" entityLabel="Universe"
